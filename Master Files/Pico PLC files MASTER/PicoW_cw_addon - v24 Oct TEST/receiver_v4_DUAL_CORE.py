# reciever_v4_DUAL_CORE.py - from OpenPLC using v22, for displaying data via thread. now with logo graphic
import os
import machine
import _thread
...
while True:
    ...
    if len(Cmsg) >= 4:  # incase the serial data is a bit short
        print(Cmsg[0], " ", Cmsg[3])
